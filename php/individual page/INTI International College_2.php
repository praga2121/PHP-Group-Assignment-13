...
$sql = 'SELECT college_id, name, college_description FROM college_website.colleges WHERE name="INTI International College"';
...
echo '<div class="featured-container-colleges" style="background-image: url(\'../../images/' . $row["name"] . '.png\')">';
